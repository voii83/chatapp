...
use app\models\user\ResendVerificationEmailForm;
    ...
    public function actionVerifyEmail($token)
    {
        ...
        if ($user = $model->verifyEmail()) {
            if (Yii::$app->user->login($user)) {
                ...
                if(!Yii::$app->authManager->checkAccess($user->id, User::USER_ROLE_USER, $params = [])){
                    $auth = Yii::$app->authManager;
                    $guest = $auth->getRole(User::USER_ROLE_GUEST);
